...
describe('resource jobsBoard', () => {
  // Mock server tests are disabled
  test.skip('refresh', async () => {
    const responsePromise = client.jobsBoard.refresh();
  ...
  test.skip('refresh: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.jobsBoard.refresh({ 'X-Service-Key': 'X-Service-Key' }, { path: '/_stainless_unknown_path' }),
